...
export const DevCategoriesList = () => {
  ...
  return [
    t("graphicDesign:devCategories.list.list1"),
    t("graphicDesign:devCategories.list.list2"),
    t("graphicDesign:devCategories.list.list3"),
    t("graphicDesign:devCategories.list.list4"),
  ];
};
