...
export const DevCategoriesList = () => {
  ...
  return [
    t("seoManagement:devCategories.list.list1"),
    t("seoManagement:devCategories.list.list2"),
    t("seoManagement:devCategories.list.list3"),
    t("seoManagement:devCategories.list.list4"),
    t("seoManagement:devCategories.list.list5"),
  ];
};
