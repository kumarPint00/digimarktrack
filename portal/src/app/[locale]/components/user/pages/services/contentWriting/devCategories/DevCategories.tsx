...
import benefitimage from "../../../../../../../../../public/unnamed (2) 1.webp";
    ...
    <>
      <Box sx={{ display: "flex", justifyContent: "center" }}>
        <Typographyh5 variant="h6" color="initial" gutterBottom>
          <TranslationAtom word="contentWriting:devCategories.heading" />
        </Typographyh5>
      </Box>
      <MainBox>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={6} md={6} lg={6} xl={6}>
              <Typo1 variant="body2" color="initial">
                <TranslationAtom word="contentWriting:devCategories.para" />
              </Typo1>
              <ListComponent />
            </Grid>
          </Grid>
