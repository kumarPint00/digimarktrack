...
export const DevCategoriesList = () => {
  ...
  return [
    t("eCommerce:devCategories.list.list1"),
    t("eCommerce:devCategories.list.list2"),
    t("eCommerce:devCategories.list.list3"),
    t("eCommerce:devCategories.list.list4"),
    t("eCommerce:devCategories.list.list5"),
  ];
};
